...
//     // const { error: updateError, isUpdated } = useSelector((state) => state.order); // order is a reducer for update and delete order
...
//         //                 <div>
//         //                     <AccountTreeIcon />
//         //                     <select value={category} onChange={(e) => setStatus(e.target.value)}>
